...
public class TimeTableTest {
	 ...
	 @Test
	  ...
	  Appt mutant = new Appt(23, 32, 22, 11, 2018, "Party Birthday2", "This is my party birthday2");
	  ...
	  //add null app to delete and kill mutant
	  assertNull(t.deleteAppt(appts, null));
	  assertNull(t.deleteAppt(null, mutant));

	  //kill mutant if (!appt.getValid())
	  assertNull(t.deleteAppt(appts, mutant2));
...
/*
	 ...
	 @Test
	  ...
	  LinkedList<Appt> appts = new LinkedList<Appt>();
	  Appt first = new Appt(21, 30, 14, 11, 2018, "Birthday Party", "This is my birthday party");
	  Appt second = new Appt(21, 30, 14, 11, 2018, "Birthday Party", "This is my birthday party");
	  ...
	  second.setRecurrence(recurNew, 1, 2, 4);
	  appts.add(second);


	  assertNotNull(t.getApptRange(appts,initial, last));
	  assertEquals(2, t.getApptRange(appts, initial, last).get(0).getSizeAppts());
